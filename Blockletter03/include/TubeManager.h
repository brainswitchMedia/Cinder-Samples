...
public:
    ...
    void preComputeParticlePositions( vector <ci::vec3> &alocParticleEmitters );
    void addTube( int shapeType );
    void removeTube();
    TubeParticles* getTupeParticle( int i );
    void update( vector <ci::vec3> &alocParticleEmitters, mat3 sceneRotation );
    void updatePrecomputedTubePosition( mat3 sceneRotation );
    ...
    float                   mPublicLengthGrowtimer = 0.0f;
