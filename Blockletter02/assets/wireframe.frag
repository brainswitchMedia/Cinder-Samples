...
void main()
{
    ...
    vec3 finalColor = clamp( translulencyDist, 0.0, 1.0 ) * ( 7.0 * colorMix + uColor * pow( ( 1.0 - sin( uCircleSize * distToCenterLight ) ), uPower1 )  ) + 12.0 * uColor  * specular;
