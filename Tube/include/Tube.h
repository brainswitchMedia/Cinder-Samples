...
public:
    ...
    //float                               mVelCoef = 1.0f;
    //double                              mCounterTime;
    //int                                 mParticleNumber = 100;
    
    int                             mTubeNum;
    float                           mRandom;
    
    std::vector<ci::vec3>           mtesttab1;
    std::vector<ci::vec3>           mtesttab2;
    vec3                            mTestVector1 = vec3( 0.0f, 0.0f, 0.0f );
    vec3                            mTestVector2 = vec3( 0.0f, 0.0f, 0.0f );
    vec3                            mTestVector3 = vec3( 0.0f, 0.0f, 0.0f );
    vec3                            mNewVertex = vec3( 0.0f, 0.0f, 0.0f );
    vec3                            mRotatedVertex = vec3( 0.0f, 0.0f, 0.0f );
    vec3                            mFirstVertexTest = vec3( 0.0f, 0.0f, 0.0f );
    float                           mTestAngle = 0.0f;
