...
float edgeFactor()
{
    ...
    if ( uLineStyle == 1 )
    {
        ...
        a3 = smoothstep( vec3(0.0), d * 2.0, baricentric );
    }
...
void main()
{
    vec3 spectrumCol = texture( uTexSpectrum, vec2( 0.1, 0.1 ) ).rgb;
    ...
    oFragColor0.rgb = uColor;
	oFragColor0.a = 1.0;
    
    oFragColor1.rgb = colorMix;
    oFragColor1.a = 1.0;
    
    oFragColor2.rgb = colorMix;
    oFragColor2.a = 1.0;
}
